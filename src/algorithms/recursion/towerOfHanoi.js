...
export const TOWER_OF_HANOI_METADATA = Object.freeze({
  ...
  education: {
    coreIdea: "الفكرة الأساسية هي تقسيم مسألة نقل n قرصاً إلى مسألتين أصغر من نفس النوع: أولاً ننقل الأقراص العلوية (n - 1) من المصدر إلى العمود المساعد، ثم ننقل أكبر قرص مباشرة من المصدر إلى الهدف، ثم ننقل الأقراص (n - 1) من العمود المساعد إلى الهدف. وهكذا نحل المسألة الكبيرة بالاعتماد على حل نفس المسألة لعدد أقراص أصغر.",
    howItWorks: [
      "إذا كان لدينا قرص واحد فقط (الحالة الأساسية)، ننقله مباشرة من المصدر إلى الهدف وننتهي.",
      "إذا كان لدينا أكثر من قرص، ننقل أولاً كل الأقراص العلوية (n - 1) من المصدر إلى العمود المساعد، مستخدمين الهدف كعمود وسيط مؤقت.",
      "بعد ذلك ننقل القرص الأكبر المتبقي مباشرة من المصدر إلى الهدف.",
      "أخيراً ننقل الأقراص (n - 1) التي وضعناها في العمود المساعد إلى الهدف، مستخدمين المصدر هذه المرة كعمود وسيط.",
    ],
    example: "لنقل قرصين من A إلى C: ننقل القرص العلوي من A إلى B (عمود مساعد)، ثم ننقل القرص الأكبر من A إلى C مباشرة، ثم ننقل القرص الذي كان في B إلى C. بذلك انتقل القرصان معاً من A إلى C في 3 حركات فقط، محترمين قاعدة عدم وضع قرص أكبر فوق قرص أصغر.",
  },
  requiresCount: true,
