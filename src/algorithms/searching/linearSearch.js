...
export const LINEAR_SEARCH_METADATA = Object.freeze({
  ...
  education: {
    coreIdea: "الفكرة الأساسية هي فحص عناصر القائمة واحداً تلو الآخر بالترتيب، بدءاً من البداية، حتى نجد القيمة المطلوبة أو نصل إلى نهاية القائمة دون إيجادها.",
    howItWorks: [
      "نبدأ من أول عنصر في القائمة.",
      "نقارن قيمته بالقيمة المطلوبة (الهدف).",
      "إذا تطابقتا، نتوقف ونعلن أننا وجدنا الهدف في هذا الموضع.",
      "إذا لم تتطابقا، ننتقل إلى العنصر التالي ونكرر المقارنة.",
      "إذا وصلنا إلى نهاية القائمة دون إيجاد تطابق، نعلن أن الهدف غير موجود.",
    ],
    example: "للبحث عن القيمة 8 في [5, 3, 8, 2]: نقارن 5 مع 8 (لا تطابق)، ثم 3 مع 8 (لا تطابق)، ثم 8 مع 8 (تطابق!) فنعلن أننا وجدنا الهدف في الموضع الثالث.",
  },
  requiresTarget: true,
