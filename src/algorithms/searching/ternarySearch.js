...
export const TERNARY_SEARCH_METADATA = Object.freeze({
  ...
  education: {
    coreIdea: "الفكرة الأساسية تشبه البحث الثنائي، لكن بدل تقسيم مجال البحث إلى نصفين، نقسّمه إلى ثلاثة أجزاء متساوية تقريباً باستخدام نقطتين، ثم نستبعد الجزء أو الأجزاء التي لا يمكن أن تحتوي على الهدف بناءً على مقارنتين بدل مقارنة واحدة.",
    howItWorks: [
      "نحدد بداية ونهاية مجال البحث، ونحسب نقطتين تقسمانه إلى ثلاثة أجزاء متقاربة.",
      "نقارن الهدف بقيمتي هاتين النقطتين.",
      "إذا تطابق الهدف مع إحداهما، نكون قد وجدناه.",
      "إذا كان الهدف أصغر من النقطة الأولى، نبحث فقط في الثلث الأيسر.",
      "إذا كان الهدف أكبر من النقطة الثانية، نبحث فقط في الثلث الأيمن.",
      "وإلا، فإن الهدف يقع بين النقطتين، فنبحث فقط في الثلث الأوسط.",
    ],
    example: "للبحث عن القيمة 8 في [2, 3, 5, 8, 9, 11]: نقسّم المجال بنقطتين تشيران إلى القيمتين 3 و9. بما أن 8 أكبر من 3 وأصغر من 9، نستبعد الثلث الأيسر والثلث الأيمن، ونواصل البحث فقط في الجزء الأوسط [5, 8] حيث نجد القيمة 8 مباشرة.",
  },
