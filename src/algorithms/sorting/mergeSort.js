...
export const MERGE_SORT_METADATA = Object.freeze({
  ...
  education: {
    coreIdea: "الفكرة الأساسية هي 'فرّق تسد': نقسم القائمة إلى نصفين أصغر بشكل متكرر حتى نصل إلى أجزاء من عنصر واحد (وهي مرتبة تلقائياً)، ثم ندمج هذه الأجزاء الصغيرة معاً بترتيب صحيح لنحصل تدريجياً على قائمة أكبر مرتبة.",
    howItWorks: [
      "نقسم القائمة إلى نصفين تقريباً متساويين.",
      "نكرر تقسيم كل نصف إلى نصفين أصغر حتى يبقى عنصر واحد في كل جزء.",
      "ندمج كل جزأين صغيرين معاً، بمقارنة عناصرهما واختيار الأصغر في كل مرة لوضعه في القائمة الجديدة.",
      "نكرر عملية الدمج للأجزاء الأكبر تدريجياً حتى تعود القائمة كاملة ومرتبة.",
    ],
    example: "لترتيب [5, 3, 8, 2]: نقسمها إلى [5, 3] و[8, 2]. نقسم كل جزء بدوره إلى عناصر مفردة، ثم ندمج [5] و[3] لنحصل على [3, 5]، وندمج [8] و[2] لنحصل على [2, 8]. أخيراً ندمج [3, 5] و[2, 8] بمقارنة العناصر تباعاً فنحصل على [2, 3, 5, 8].",
  },
