...
export const SELECTION_SORT_METADATA = Object.freeze({
  ...
  education: {
    coreIdea: "الفكرة الأساسية هي البحث في كل مرة عن أصغر عنصر في الجزء غير المرتب من القائمة، ثم وضعه مباشرة في أول موضع فارغ من الجزء المرتب.",
    howItWorks: [
      "نفترض أن أول عنصر هو الأصغر مؤقتاً.",
      "نمر على بقية العناصر ونبحث عن قيمة أصغر منه.",
      "إذا وجدنا عنصراً أصغر، نحدّث موضع الأصغر الحالي.",
      "بعد الانتهاء من المسح، نبدّل الأصغر الذي وجدناه مع أول عنصر في الجزء غير المرتب.",
      "نكرر نفس الخطوات بدءاً من الموضع التالي حتى ترتيب كامل القائمة.",
    ],
    example: "لنرتب [5, 3, 8, 2]: أصغر عنصر في القائمة كاملة هو 2، فنبدّله مع 5 → [2, 3, 8, 5]. بعدها نبحث عن أصغر عنصر في الجزء المتبقي [3, 8, 5]، وهو 3، وهو موجود أصلاً في مكانه الصحيح. نكرر العملية حتى تكتمل القائمة.",
  },
