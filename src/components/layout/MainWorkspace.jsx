...
export default function MainWorkspace({ selectedAlgorithm, onSelectAlgorithm, currentStep, steps, currentStepIndex, executionLog, array, onApplyArray, target, onTargetChange }) {
  ...
  return (
    <main className="relative grid grid-cols-10 min-h-0 flex-1 overflow-hidden border-b border-border" aria-label="مساحة العمل الرئيسية">
        ...
        <AlgorithmSidebar selectedAlgorithm={selectedAlgorithm} onSelectAlgorithm={onSelectAlgorithm} array={array} setIsArrayEditorOpen={setIsArrayEditorOpen} target={target} onTargetChange={onTargetChange} />
