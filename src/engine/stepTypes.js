...
export function getStepVisualState(step) {
  ...
  return {
    ...
    eliminatedRanges: step?.metadata?.eliminatedRanges ?? [],
    searchPointers: {
      ...
      mid1: Number.isInteger(step?.metadata?.mid1) ? step.metadata.mid1 : null,
      mid2: Number.isInteger(step?.metadata?.mid2) ? step.metadata.mid2 : null,
